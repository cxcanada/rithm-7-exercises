...
1.  [Introduction To Flask](./flask/01-flask-intro)
1.  [Routing with Flask](./flask/02-flask-routing)
1.  [Templating with Jinja2](./flask/03-templating)
1.  [CRUD with Flask](./flask/04-flask-crud)
1.  [SQL Alchemy, Part I](./flask/05-sql-alchemy-1)
1.  [Migrations](./flask/06-migrations)
1.  [SQL Alchemy, Part II](./flask/07-sql-alchemy-2)
1.  [Testing With Flask](./flask/08-testing)
1.  [Server Side Validation with WTForms](./flask/09-forms)
1.  [Heroku](./flask/10-heroku)
1.  [Structuring Larger Flask Applications](./flask/11-blueprints)
1.  [Many to Many](./flask/12-many-to-many)
1.  [Hashing and Sessions](./flask/13-hashing-sessions)
1.  [Authentication with Flask Login](./flask/14-flask-login)
1.  [OAuth with Flask](./flask/15-oauth)
